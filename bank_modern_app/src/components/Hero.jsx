      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px]">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            <span className='text-white'>20%</span> For {" "}
            <span className='text-white'>1 Month</span> Account
          </p>
        </div>

        <div className='flex flex-row justify-beetween items-center w-full'>
          <h1 className='flex-1 font-poppins text-white font-semibold ss:text-[72px] text-[52px] ss:leading-[100px] leading-[75px]'>The Next <br className='sm:block hidden'/> {" "}
